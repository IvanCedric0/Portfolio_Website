  ...
  return (
    <section id="about" className="container-wide py-20 border-t border-border">
      ...
      >
        {/* Left — bio + experience */}
        <div>
          <p className="label-caps mb-5">About</p>
          <p className="text-foreground-2 text-base leading-relaxed mb-4">
            CS student at{" "}
          ...
          <p className="text-foreground-3 text-sm leading-relaxed mb-8">
            ...
            {EXPERIENCES.map((exp) => (
              ...
              >
                <div className="flex-1">
                  <p className="text-sm font-semibold text-foreground-2">{exp.role}</p>
        ...
        {/* Right — skills grid */}
        <div>
          <p className="label-caps mb-5">Skills</p>
